...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nengo-spa-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15045&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nengo-spa-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nengo-spa` can be installed with:

```
conda install nengo-spa
```

It is possible to list all of the versions of `nengo-spa` available on your platform with:
